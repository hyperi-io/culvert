...
| `openvpn-auth-oauth2` | [github.com/jkroepke/openvpn-auth-oauth2](https://github.com/jkroepke/openvpn-auth-oauth2) | `1.28.0`, `sha256`-verified per arch |
| `wstunnel` | [github.com/erebe/wstunnel](https://github.com/erebe/wstunnel) | `10.5.5`, `sha256`-verified per arch |
...
| `scalo` (HyperI-own) | PyPI | `==2.29.10`; ships immediately (no cooldown); `uv.lock` pins the dev/CI tree with hashes |
...
ARG OPENVPN_AUTH_OAUTH2_VERSION="1.28.0"   # + SHA256_AMD64 / SHA256_ARM64
ARG WSTUNNEL_VERSION="10.5.5"              # + SHA256_AMD64 / SHA256_ARM64
```
