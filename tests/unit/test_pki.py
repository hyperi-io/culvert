...
class TestCreateProvider:
    ...
    def test_file_provider(self, clean_env, monkeypatch):
        from lib.config import Config
        from lib.pki import create_provider
        ...
        try:
            ...
            assert "FileProvider" in type(provider).__name__
        finally:
            provider.close()
...
class TestFetchExternalPki:
    ...
    def pki_env(self, tmp_path, clean_env, monkeypatch):
        ...
        monkeypatch.setenv("HYPERI_VPN_SECRETS_PROVIDER", "file")
        monkeypatch.setenv("HYPERI_VPN_SECRETS_CA_CERT_PATH", str(src / "ca.crt"))
        monkeypatch.setenv(
        ...
        monkeypatch.setenv("HYPERI_VPN_SECRETS_CRL_PATH", str(src / "crl.pem"))
