...
FAKE_CA = (
    "-----BEGIN CERTIFICATE-----\n"
    "TEST_CA_CERT_FOR_CULVERT_INTEGRATION\n"
    "-----END CERTIFICATE-----\n"
)
FAKE_CERT = (
    "-----BEGIN CERTIFICATE-----\n"
    "TEST_SERVER_CERT_FOR_CULVERT_INTEGRATION\n"
    "-----END CERTIFICATE-----\n"
)
FAKE_KEY = (
    "-----BEGIN PRIVATE KEY-----\n"
    "TEST_SERVER_KEY_FOR_CULVERT_INTEGRATION\n"
    "-----END PRIVATE KEY-----\n"
)

SECRET_BASE = "secret/data/culvert-test"
TEST_SECRETS = {
    "ca-cert": FAKE_CA,
...
def test_openbao_health():
    ...
    from scalo.secrets.providers.openbao import (
        OpenBaoProvider,
    )
    ...
    try:
        ...
        # close() is async - run the coroutine or the session leaks
